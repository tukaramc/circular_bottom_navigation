...
class _CircularBottomNavigationState extends State<CircularBottomNavigation>
  ...
  Widget build(BuildContext context) {
    ...
    children.add(Positioned(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          /* boxShadow: [new BoxShadow(color: Color(0xFF1A191E), blurRadius: 2.0)] */
        ),
      ),
    ...
    //         border: Border.all(
    //             width: widget.circleStrokeWidth, color: Color(0xFF4ec0f5))),
    //   ),
    ...
    boxes.asMap().forEach((int pos, Rect r) {
      ...
      double scaleFactor = pos == selectedPos ? 1.4 : 1.2;
      children.add(
        Positioned(
          child: Transform.scale(
              ...
              child: new Container(
                margin: EdgeInsets.only(
                    left: 5.0, top: pos == selectedPos ? 13.0 : 3.0),
                child: new Image.asset(
                  widget.tabItems[pos].img,
                  height: 22.0,
                  width: 22.0,
                  color: pos == selectedPos ? Color(0xFF4ec0f5) : Colors.white,
        ...
        child: Container(
          ...
          child: Center(
            ...
            child: Text(
              ...
              style: TextStyle(color: Color(0xFF4ec0f5)),
            ),
          )),
        ),
        left: r.left,
